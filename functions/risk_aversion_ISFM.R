...
round_1 <- c(338,100,325,344,12,330,347,322,293,219)

round_2 <- c(329,341,119,69,334,346,46,333,327,339)

round_3 <- c(169,342,336,34,345,326,340,337,158,164)

round_4 <- c(64,160,159,261,253,293,158,169,166,117)
