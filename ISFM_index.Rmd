...
```{r echo=FALSE, fig.cap="Improved seed", fig.align='center', out.width="60%"}
knitr::include_graphics("figures/improved seed_ISFM1.png")
...
```{r echo=FALSE, fig.cap="Mineral fertilizer", fig.align='center', out.width="60%"}
knitr::include_graphics("figures/Mineral fertilizer_ISFM2.png")
...
```{r echo=FALSE, fig.cap="Organic fertilizer", fig.align='center', out.width="60%"}
knitr::include_graphics("figures/Organic fertilizer ISFM3.png")
...
```{r echo=FALSE, fig.cap="Fertilizer combination", fig.align='center', out.width="60%"}
knitr::include_graphics("figures/Fertilizer combination_ISFM4.png")
...
```{r echo=FALSE, fig.cap="Minimum tillage", fig.align='center', out.width="60%"}
knitr::include_graphics("figures/Minimum tillage_ISFM5.png")

```

**Complete ISFM**
When all the above components are fully adopted simultaneously. 
```{r echo=FALSE, fig.cap="Complete ISFM", fig.align='center', out.width="60%"}
knitr::include_graphics("figures/Complete ISFM.png")
...
```{r Intersectionality NPV ranges, warning=FALSE, message=FALSE}
...
```{r pls data ISFM components, warning=FALSE, message=FALSE}
ISFM_implimentation_level_income<- ISFM_mc_simulation$y %>%
  select(7, 12, 17, 22, 27, 32)
```


```{r ISFM implimentation levels Projection to Latent Structure, warning=FALSE, message=FALSE}
...
```{r pls data intersectionality, warning=FALSE, message=FALSE}
...
```{r Pls bubble plot, warning=FALSE, message=FALSE}
