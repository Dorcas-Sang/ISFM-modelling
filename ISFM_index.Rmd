...
resource_labels <- c(
  ...
  "Land"      = "With land-related issues",
  "Inputs"    = "With inputs-related issues",
  "Knowledge" = "With knowledge-related issues",
  "Labour"    = "With labour-related issues"
)
...
ggsave("figures/new_NPV_ISFM_gender_resource.png", 
       p_side_by_side, width = 9, height = 5, dpi = 1500)
...
ISFM_components_cashflow_plot <- plot_cashflow(
  ...
  color_median        = "red",
  base_size = 35
)+  ggplot2::scale_y_continuous(limits = c(0, 25000)) +
theme(
...
if ("FacetWrap" %in% class(ISFM_components_cashflow_plot$facet)) {
  ISFM_components_cashflow_plot$facet$params$ncol <- 7
}


# Save the plot
ggsave("figures/ISFM_components_cashflow_plot.png", width = 33, height = 15, dpi = 1000)
```
