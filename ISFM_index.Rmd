...
Based on these identified farmers' archetypes we present the economic return of full ISFM components (complete adoption) which  encompasses the income based on available resources and gender. We represent this as NPVs and cashflows depending on the identified vital resources for ISFM: land, agricultural inputs/finance, knowledge, and labor. 
